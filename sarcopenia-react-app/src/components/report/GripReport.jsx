...
export default function GripReport({ patientName, onClose, onSwitchDynamic, pythonResult }) {
  ...
  const tooltipStyle = { backgroundColor: '#FFFFFF', borderColor: '#E5E9EF', textStyle: { color: '#1A2332' }, extraCssText: 'box-shadow: 0 4px 20px rgba(0,0,0,0.08); border-radius: 8px;', valueFormatter: (v) => typeof v === 'number' ? v.toFixed(2) : v };
